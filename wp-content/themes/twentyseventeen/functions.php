...
function twentyseventeen_scripts() {
	...
	wp_enqueue_style( 'fixed', get_template_directory_uri() . '/assets/css/fixed.css',false);
	wp_enqueue_style( 'mobile', get_template_directory_uri() . '/assets/css/mobile.css',false);

	if (is_rtl()) {
		wp_enqueue_style( 'style-rtl', get_template_directory_uri() . '/style-rtl.css', array(), $version );
	}
